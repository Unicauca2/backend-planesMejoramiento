...
public class ResourceServerConfig extends ResourceServerConfigurerAdapter {
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		config.setAllowedOrigins(Arrays.asList(
				"https://oci-planes-mejoramiento-n7tqc.ondigitalocean.app",
				"http://localhost:4200",
				"https://fiet.unicauca.edu.co/oficina-control-interno",
				"https://oci-frontend.fly.dev/oficina-control-interno",
				"https://oci-frontend.fly.dev",
				"https://rectoria.unicauca.edu.co/oficina-control-interno"));
